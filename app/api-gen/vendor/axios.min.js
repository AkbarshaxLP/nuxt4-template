      ...
      isFormData: function (e) {
        ...
        return (
          ...
          (('function' == typeof FormData && e instanceof FormData) ||
            (D(e.append) &&
              ('formdata' === (t = L(e)) ||
                ('object' === t && D(e.toString) && '[object FormData]' === e.toString()))))
        )
      },
        ...
        if (ve.endsWith(r, '{}')) ((r = n ? r : r.slice(0, -2)), (e = JSON.stringify(e)))
          ...
          return (
            ...
            s.forEach(function (e, n) {
              !ve.isUndefined(e) &&
                null !== e &&
                t.append(!0 === a ? Ee([r], n, i) : null === a ? r : r + '[]', u(e))
            }),
            !1
          )
            ...
            ve.forEach(r, function (r, i) {
              !0 ===
                (!(ve.isUndefined(r) || null === r) &&
                  o.call(t, r, ve.isString(i) ? i.trim() : i, n, p)) && e(r, n ? n.concat(i) : [i])
            }),
            l.pop())
        }
      })(e),
      ...
      function (e) {
        return new Promise(function (t, r) {
          ...
          O && -1 === Be.protocols.indexOf(O)
            ? r(new ye('Unsupported protocol ' + O + ':', ye.ERR_BAD_REQUEST, e))
            : v.send(c || null)
        })
      },
    pt = function (e, t) {
        ...
        function (t) {
          return (
            Xe(t) ||
              ...
              t &&
                t.response &&
                ((t.response.data = Ge.call(e, e.transformResponse, t.response)),
      ...
      return (
        y(e, [
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              ;(void 0 !== n &&
                ...
                Ft.assertOptions(
                  t,
                  { baseUrl: Bt.spelling('baseURL'), withXsrfToken: Bt.spelling('withXSRFToken') },
                  !0
                ),
          ...
          },
          {
            ...
            value: function (e) {
              return je(
                it((e = st(this.defaults, e)).baseURL, e.url, e.allowAbsoluteUrls),
                e.params,
                e.paramsSerializer
              )
            },
